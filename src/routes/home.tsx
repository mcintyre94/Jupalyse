...
export default function Home() {
    ...
    const addressColor = validAddress === false ? 'red' : validAddress === true ? 'green' : undefined;
            ...
            <Stack gap='xl'>
                <Stack gap='xs'>
                    <Text
                        ...
                        component='h1'
                        variant='gradient'
                        gradient={{ from: 'rgb(28, 197, 225) 0.21%', to: 'rgb(199, 242, 132) 115.96%', deg: 89 }}
                        style={{ fontSize: '5rem' }}
                        fw='bolder'
                    >Jupalyse</Text>

                    <Title ta='center' order={3}>View and download your Jupiter DCA trades</Title>
                </Stack>
                ...
                <Form method='POST'>
                    <Stack gap='md' align='flex-start'>
                        <TextInput
                            ...
                            styles={{
                                input: {
                                    outline: addressColor ? `3px solid ${addressColor}` : undefined,
